...
App::App()
{
    InitializeComponent(); // Initialize UWP components
    Suspending += ref new SuspendingEventHandler(this, &App::OnSuspending); // Prepare to handle window suspension
}
...
void App::OnLaunched(Windows::ApplicationModel::Activation::LaunchActivatedEventArgs^ e)
{
	...
	// Extend the user view into the title bar
	// (allows us to make it acrylic, add tabs, etc.)
